...
for (const file of ['widget.js', 'screenshot.js', 'annotate.js', 'preview.js'])
  cpSync(new URL(file, src), new URL(file, dest));
console.log('Copied widget.js, screenshot.js, annotate.js and preview.js into apps/web/public/w/');
