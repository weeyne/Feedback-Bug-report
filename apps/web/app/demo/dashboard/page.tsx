...
import { decodeDemoReport, toFeedbackDetail } from '@/components/marketing/demo/dashboard-report';
...
// Reads `?r=` and stamps the report with the request time.
 ...
 * freshly received feedback of a fixture project. No session, database or API: every value comes
 * from the query or from constants. Links keep their real targets; the demo iframe is inert.
 */
export default async function DemoDashboardPage({
  ...
  const report = decodeDemoReport(typeof r === 'string' ? r : undefined, locale);
